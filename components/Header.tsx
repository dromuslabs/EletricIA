        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400 font-medium leading-none">Power Line Systems</p>
            </div>
          </div>
          ...
          <div className="flex items-center space-x-4">
            <nav className="hidden md:flex space-x-6 mr-4">
              ...
              <a href="#" className="text-sm font-medium text-slate-400 hover:text-white transition-colors">Relatórios</a>
            </nav>
            <button 
